...
export async function addAsync(
  ...
  try {
    ...
    switch (conditionType) {
      case "sensor":
        if (
          (request.app.get(DI_KEYS.SensorList) as SensorList).sensors[
  ...
  try {
    ...
    switch (conditionType) {
      case "sensor": {
        ...
        const nextGroupType =
          (request.body.groupType as ConditionGroupType | undefined) ??
          sdbSensorCondition.groupType;
        condition = new SensorCondition(
          sdbSensorCondition.id,
          nextGroupType,
          (request.body.sensorId as number | undefined) ?? sdbSensorCondition.sensorId,
          (request.body.readingType as ReadingType | undefined) ?? sdbSensorCondition.readingType,
          (request.body.operator as ConditionOperator | undefined) ?? sdbSensorCondition.operator,
      ...
      case "output": {
        ...
        condition = new OutputCondition(
          ...
          nextGroupType,
          (request.body.outputId as number | undefined) ?? sdbOutputCondition.outputId,
          (request.body.operator as ConditionOperator | undefined) ?? sdbOutputCondition.operator,
          (request.body.comparisonValue as number | undefined) ??
        ...
        if (request.app.get(DI_KEYS.OutputList).outputs[condition.outputId] == null) {
      ...
      case "time": {
        ...
        const nextGroupType =
          (request.body.groupType as ConditionGroupType | undefined) ?? sdbTimeCondition.groupType;
      ...
      case "month": {
        ...
        const nextGroupType =
          (request.body.groupType as ConditionGroupType | undefined) ?? sdbMonthCondition.groupType;
      ...
      case "date-range": {
        ...
        if (
          dateRangeCondition.startDate < 1 ||
          ([1, 3, 5, 7, 8, 10, 12].includes(dateRangeCondition.startMonth) &&
            dateRangeCondition.startDate > 31) ||
          ([4, 6, 9, 11].includes(dateRangeCondition.startMonth) &&
            dateRangeCondition.startDate > 30) ||
          (dateRangeCondition.startMonth == 2 && dateRangeCondition.startDate > 29)
        ) {
        ...
        if (
          dateRangeCondition.endDate < 1 ||
          ([1, 3, 5, 7, 8, 10, 12].includes(dateRangeCondition.endMonth) &&
            dateRangeCondition.endDate > 31) ||
          ([4, 6, 9, 11].includes(dateRangeCondition.endMonth) &&
            dateRangeCondition.endDate > 30) ||
          (dateRangeCondition.endMonth == 2 && dateRangeCondition.endDate > 29)
        ) {
