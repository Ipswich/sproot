...
import { NotificationActionUpdatedEvent } from "../../../eventbus/events/actions/NotificationActionEvents";
...
describe("NotificationActionManager.ts tests", () => {
  ...
  describe("activeNotifications", () => {
    it("should return active notifications with correct structure", async () => {
      const notificationActions = createStubNotificationActionsRepository() as any;
  ...
  describe("error handling", () => {
    it("should log error when reloading actions fails", async () => {
      ...
      notificationActions.getAllAsync.rejects(new Error("DB Error"));
