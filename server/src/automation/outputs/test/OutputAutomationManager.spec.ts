  ...
  describe("evaluate", () => {
    it("should return the automation's value (conditions met)", async () => {
      ...
      sprootDB.getAutomationsForOutputAsync.resolves([
        { automationId: 1, outputAutomationId: "1", name: "test", outputId: "1", value: 75, operator: "or" } as SDBOutputAutomation,
      ]);
    ...
    it("should return null (more than one automation evaluates to true)", async () => {
      ...
      sprootDB.getAutomationsForOutputAsync.resolves([
        { automationId: 1, outputAutomationId: "1", name: "test", outputId: "1", value: 75, operator: "or" } as SDBOutputAutomation,
        { automationId: 2, outputAutomationId: "2", name: "test2", outputId: "1", value: 50, operator: "and" } as SDBOutputAutomation
      ]);
