              ...
              {systemStatusQuery.data && (
                <Accordion w="90%" multiple={true}>
                      ...
                      >
                        <Table.Tbody>
                          <Table.Tr>
                            ...
                            <Table.Td>
                              {(
                                systemStatusQuery.data.process.uptime / 3600
                              ).toFixed(2)}{" "}
                              hours
                            </Table.Td>
                          </Table.Tr>
                  ...
                  <Accordion.Item value="system">
                    <Accordion.Control icon={<IconStack />}>
                      System
                    </Accordion.Control>
                    <Accordion.Panel>
                      <Table
                      ...
                      >
                        <Table.Tbody>
                          <Table.Tr>
                            ...
                            <Table.Td>
                              {(
                                systemStatusQuery.data.system.totalDiskSize /
                                1024
                              ).toFixed(2)}{" "}
                              GB
                            </Table.Td>
                          ...
                          <Table.Tr>
                            ...
                            <Table.Td>
                              {(
                                systemStatusQuery.data.system.freeDiskSize /
                                1024
                              ).toFixed(2)}{" "}
                              GB
                            </Table.Td>
                      ...
                      >
                        <Table.Tbody>
                          <Table.Tr>
                            ...
                            <Table.Td>
                              {systemStatusQuery.data.database.size.toFixed(2)}{" "}
                              MB
                            </Table.Td>
                          </Table.Tr>
                          <Table.Tr>
