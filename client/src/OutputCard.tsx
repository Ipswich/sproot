...
import { setOutputControlModeAsync, setOutputManualStateAsync } from "./requests";
...
export default function OutputCard({ output, updateOutputsAsync }: OutputCardProps) {
  return (
    <div>
      ...
      <button onClick={async () => 
        await setOutputControlModeAsync(output.id)}>
