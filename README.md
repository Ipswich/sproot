...
<div>
<img width="24%" alt="Sproot Sensor Data" src="docs/static/img/SensorData.png">
<img width="24%" alt="Sproot Output States" src="docs/static/img/OutputStates.png">
<img width="24%" alt="Sproot Automations" src="docs/static/img/Automations.png">
<img width="24%" alt="Sproot Sensor Configuration" src="docs/static/img/SensorSettings.png">
</div>
