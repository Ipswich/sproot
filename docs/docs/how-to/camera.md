...
<p style={{ textAlign: 'center' }}>
  <img src="/img/CameraSettings.png" alt="Camera Settings" style={{ width: '30%', maxWidth: '100%', height: 'auto' }} />
</p>
...
<p style={{ textAlign: 'center' }}>
  <img src="/img/LiveView.png" alt="Live View" style={{ width: '30%', maxWidth: '100%', height: 'auto' }} />
</p>
