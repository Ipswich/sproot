...
export const CAMERA_LATEST_IMAGE_REFRESH_INTERVAL_SECONDS_MIN = 1;
export const CAMERA_LATEST_IMAGE_REFRESH_INTERVAL_SECONDS_MAX = 60;
export const CAMERA_LATEST_IMAGE_REFRESH_INTERVAL_SECONDS_DEFAULT = 60;
export const CAMERA_MAINTENANCE_INTERVAL_SECONDS = 60;
