...
import { SDBOutputActionView } from "@sproot/sproot-common/src/database/SDBOutputAction";
import { AutomationOperator } from "@sproot/sproot-common/src/automation/IAutomation";
import { IOutputActionsRepository } from "./actions/IOutputActions.repository";
import { INotificationActionsRepository } from "./actions/INotificationActions.repository";
import { ISensorConditionsRepository } from "./conditions/ISensorConditions.repository";
import { IOutputConditionsRepository } from "./conditions/IOutputConditions.repository";
import { ITimeConditionsRepository } from "./conditions/ITimeConditions.repository";
import { IWeekdayConditionsRepository } from "./conditions/IWeekdayConditions.repository";
import { IMonthConditionsRepository } from "./conditions/IMonthConditions.repository";
import { IDateRangeConditionsRepository } from "./conditions/IDateRangeConditions.repository";
import { MockOutputActionsRepository } from "./actions/IOutputActions.repository";
import { MockNotificationActionsRepository } from "./actions/INotificationActions.repository";
import { MockSensorConditionsRepository } from "./conditions/ISensorConditions.repository";
import { MockOutputConditionsRepository } from "./conditions/IOutputConditions.repository";
import { MockTimeConditionsRepository } from "./conditions/ITimeConditions.repository";
import { MockWeekdayConditionsRepository } from "./conditions/IWeekdayConditions.repository";
import { MockMonthConditionsRepository } from "./conditions/IMonthConditions.repository";
import { MockDateRangeConditionsRepository } from "./conditions/IDateRangeConditions.repository";
